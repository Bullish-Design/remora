...
@pytest.mark.asyncio
async def test_syntax_error_file(tmp_path: Path, mock_store: "Any") -> None:
...
@pytest.mark.asyncio
async def test_binary_file(tmp_path: Path, mock_store: "Any") -> None:
...
@pytest.mark.asyncio
async def test_empty_file(tmp_path: Path, mock_store: "Any") -> None:
...
@pytest.mark.asyncio
async def test_very_long_function(tmp_path: Path, mock_store: "Any") -> None:
...
@pytest.mark.asyncio
async def test_unicode_content(tmp_path: Path, mock_store: "Any") -> None:
...
@pytest.mark.asyncio
async def test_nested_functions(tmp_path: Path, mock_store: "Any") -> None:
