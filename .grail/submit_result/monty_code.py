...
try:
    ...
    result = {'status': status, 'workspace_id': workspace_value, 'changed_files': normalized_files, 'summary': str(summary), 'details': {'tests_generated': int(tests_generated), 'tests_passing': int(tests_passing)}, 'error': None}
