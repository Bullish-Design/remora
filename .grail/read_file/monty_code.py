...
try:
    ...
    result = {'result': raw_result, 'summary': f'Read {line_count} lines from {file_path}', 'knowledge_delta': {'last_read_file': file_path, 'last_read_lines': line_count}, 'outcome': 'success'}
