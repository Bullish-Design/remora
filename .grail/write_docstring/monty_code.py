...
try:
    ...
    if trailing_newline:
        updated_content += '\n'
    raw_result = {'success': True, 'replaced_existing': replaced_existing, 'target_file': file_path}
    summary = 'Replaced existing docstring' if replaced_existing else 'Inserted new docstring'
    result = {'result': raw_result, 'summary': summary, 'knowledge_delta': {'docstring_updated': True, 'docstring_replaced': replaced_existing, 'docstring_target_file': file_path}, 'outcome': 'success', 'written_file': file_path, 'content': updated_content}
