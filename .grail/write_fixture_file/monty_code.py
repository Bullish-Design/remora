...
try:
    ...
    result = {'result': raw_result, 'summary': f'Wrote fixture file {target_path}', 'knowledge_delta': {'fixture_path': target_path, 'fixture_format': extension, 'fixtures_count': len(fixtures)}, 'outcome': 'success', 'written_file': target_path, 'content': content}
