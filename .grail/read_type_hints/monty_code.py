...
try:
    ...
    if not signature_line:
        ...
        raw_result = {'parameters': parameters, 'return_annotation': return_annotation, 'has_annotations': has_annotations}
        if has_annotations:
            ...
            outcome = 'partial'
        result = {'result': raw_result, 'summary': summary, 'knowledge_delta': {'type_hints_present': has_annotations, 'type_hints_count': len(parameters), 'type_hints_return': return_annotation}, 'outcome': outcome}
