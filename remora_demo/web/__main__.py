"""CLI entry point: python -m remora_demo.web [--port 8420] [--db PATH]."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Remora web graph viewer")
    ...
    from remora_demo.web.app import create_app
